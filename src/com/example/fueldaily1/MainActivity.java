...
public class MainActivity extends Activity {
   ...
   Uri uri;
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    ArrayAdapter<String> listvideosArrayAdapter = new ArrayAdapter<String>(this, R.layout.listlayout, R.id.firstLine,  list_videos_from_bucket);
		...
		//     Log.d("TAG", arg0.getItemAtPosition(position).toString() );
